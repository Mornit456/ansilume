...
/**
 * Job failure notification — HTML version.
 *
...
$this->params['previewText'] = sprintf('Job #%d failed — %s', $job->id, $template->name ?? 'unknown');
?>
<!-- Status badge -->
    ...
    <tr>
        <td style="padding-bottom:20px;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="background-color:#dc3545; color:#ffffff; font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:0.08em; padding:6px 14px; border-radius:4px; font-family:Arial, Helvetica, sans-serif;">
                        Failed
                    </td>
                </tr>
            </table>
...
<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color:#13161b; border-radius:6px; border:1px solid rgba(255,255,255,0.06);">
    ...
    <tr>
        <td style="padding:0 20px;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                    <td width="120" style="font-size:12px; color:#6c757d; padding:10px 0; font-family:Arial, Helvetica, sans-serif;">Exit code</td>
                    <td style="font-size:13px; color:#ff6b6b; font-weight:700; padding:10px 0; font-family:'Courier New', Courier, monospace;"><?= htmlspecialchars($exitCode, ENT_QUOTES, 'UTF-8') ?></td>
                </tr>
            </table>
        </td>
    </tr>
